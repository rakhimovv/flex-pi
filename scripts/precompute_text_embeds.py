...
from flexpi.models.helpers.loader import _load_registered_model, _resolve_configs
from flexpi.models.wan_video_text_encoder import HuggingfaceTokenizer
from flexpi.utils.config_resolvers import register_default_resolvers
from flexpi.utils.logging_config import get_logger, setup_logging
...
def main(cfg: DictConfig):
    ...
    # Default false: a re-run only encodes prompts the cache does not have yet.
    # `++overwrite=true` forces a full re-encode.
